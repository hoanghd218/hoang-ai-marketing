...
```bash
python3 .claude/skills/youtube-trend-finder/scripts/search_trends.py --date today --format json
```
...
```
.claude/skills/insight-extractor/references/insight-types.md
```
